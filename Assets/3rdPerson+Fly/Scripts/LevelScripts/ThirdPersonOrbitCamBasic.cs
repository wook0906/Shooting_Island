...
{
	public PlayerController player;                                           // Player's reference.
	...
	void Awake()
	{
		...
		player.GetComponent<PlayerController>().cam = this.transform;
    ...
    //Mouse:
        ...
        //Joystick:
        //      angleH += Mathf.Clamp(axis.x, -1, 1) * 60 * horizontalAimingSpeed * Time.deltaTime;
        //angleV += Mathf.Clamp(axis.y, -1, 1) * 60 * verticalAimingSpeed * Time.deltaTime;
